...
import worker from "/home/keith/Code/i-html/example-apps/todoie/.wrangler/tmp/bundle-HYcwud/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/home/keith/.cache/yay/companion/src/npm/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/home/keith/Code/i-html/example-apps/todoie/.wrangler/tmp/bundle-HYcwud/middleware-insertion-facade.js";
